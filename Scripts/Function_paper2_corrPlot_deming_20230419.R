...
paper2_corrPlot_deming <- function(myData,myTitle = "corrPlot_deming.pdf", myWidth=1.5, myHeight=1.5, myXlab = "X variable", myYlab = "Y variable", myPlotTitle = NULL, 
                                   negIdentity=FALSE, myYlim = NULL, myXlim=NULL, printRsq = FALSE, pointsCol = default_pointsCol, demingBehind = FALSE, seq_num = 0.001){
  ...
  deming.slope_seq <- seq(my.deming$ci[2,1], my.deming$ci[2,2], seq_num) 
  deming.int_seq <- seq(my.deming$ci[1,1], my.deming$ci[1,2], seq_num)
...
paper2_corrPlot_deming_Large <- function(myData,myTitle = "corrPlot_deming.pdf", myWidth=1.5, myHeight=1.5, myXlab = "X variable", myYlab = "Y variable", myPlotTitle = NULL, 
                                   negIdentity=FALSE, myYlim = NULL, myXlim=NULL, printRsq = FALSE, pointsCol = default_pointsCol, demingBehind = FALSE, seq_num = 0.01){
  print(summary(myData))
