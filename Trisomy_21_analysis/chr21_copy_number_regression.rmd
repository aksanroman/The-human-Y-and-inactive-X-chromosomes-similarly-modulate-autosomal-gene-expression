...
lcl_x_y_res_no21 <- lcl_x_y_res[(! lcl_x_y_res$chr == "chr21") & (! is.na(lcl_x_y_res$lcl_padj_X)),]                       
...
threeGroupVenn_geneNames(setA = lcl_x_y_res_no21_xsig$Gene, setAname = "X-responsive", setB = lcl_x_y_res_no21_ysig$Gene, setBname = "Y-responsive", setC = lcl_chr21_res_no21_sig$Gene, setCname = "Chr21-responsive", expGenes = exp_auto_no21, filename = "LCL_X_Y_Chr21_Venn.pdf")


#plot the X and 21 overlap
x_21_overlap <- intersect(lcl_x_y_res_no21_xsig$Gene, lcl_chr21_res_no21_sig$Gene) #201 genes
write.table(x_21_overlap, file="ChrX_and_Chr21_responsive_genes.txt", quote=FALSE, row.names = FALSE, col.names = FALSE, sep="\t")

myData <- data.frame("y" = lcl_x_y_res_no21_xsig[x_21_overlap,"lcl_log2FC_X"], "x"= lcl_chr21_res_no21_sig[x_21_overlap, "log2FoldChange"])
paper2_corrPlot_deming_Large(myData = myData, myTitle = "X_and_21_overlap_corrPlot.pdf", myWidth = 1.5, myHeight = 1.5, myYlab = "log2FC per X", myXlab = "log2FC per Chr 21", demingBehind = TRUE, myXlim = c(-6.3,5), myYlim = c(-1.2, 0.51))
...
threeGroupVenn_geneNames(setA = lcl_x_results_ChrXa_sig$Gene, setAname = "X sig", setB = lcl_y_results_ChrXa_sig$Gene, setBname = "Y sig", setC = chr21_regression_ChrXa_sig$Gene, setCname = "Chr21-responsive", expGenes = AR_values_subject$gene_name.84, filename = "LCL_Xa_X_Y_Chr21_Venn.pdf")
``` 
