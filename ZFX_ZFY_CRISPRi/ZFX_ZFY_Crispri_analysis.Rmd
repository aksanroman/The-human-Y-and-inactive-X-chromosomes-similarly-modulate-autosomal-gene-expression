...
t.test(x=myList_fib_melt[myList_fib_melt$L1 == "X_up","value"], y=myList_fib_melt[myList_fib_melt$L1 == "notSig_x","value"])
t.test(x=myList_fib_melt[myList_fib_melt$L1 == "X_down","value"], y=myList_fib_melt[myList_fib_melt$L1 == "notSig_x","value"])
...
t.test(x=myList_fib_melt[myList_fib_melt$L1 == "Y_up","value"], y=myList_fib_melt[myList_fib_melt$L1 == "notSig_y","value"])
t.test(x=myList_fib_melt[myList_fib_melt$L1 == "Y_down","value"], y=myList_fib_melt[myList_fib_melt$L1 == "notSig_y","value"])
...
t.test(x=myList_fib_melt[myList_fib_melt$L1 == "XY_up","value"], y=myList_fib_melt[myList_fib_melt$L1 == "notSig_XY","value"])
t.test(x=myList_fib_melt[myList_fib_melt$L1 == "XY_down","value"], y=myList_fib_melt[myList_fib_melt$L1 == "notSig_XY","value"])
...
t.test(x=myList_lcl_melt[myList_lcl_melt$L1 == "Y_up","value"], y=myList_lcl_melt[myList_lcl_melt$L1 == "notSig_y","value"])
t.test(x=myList_lcl_melt[myList_lcl_melt$L1 == "Y_down","value"], y=myList_lcl_melt[myList_lcl_melt$L1 == "notSig_y","value"])
...
t.test(x=myList_lcl_melt[myList_lcl_melt$L1 == "XY_up","value"], y=myList_lcl_melt[myList_lcl_melt$L1 == "notSig_XY","value"])
t.test(x=myList_lcl_melt[myList_lcl_melt$L1 == "XY_down","value"], y=myList_lcl_melt[myList_lcl_melt$L1 == "notSig_XY","value"])
...
pdf(file="XY_Cntrl_v_ZFY_volcano.pdf", width=1.75, height=1.75)
#Make volcano plot
ggplot() +
...
paper2_corrPlot_deming_err(myData = myData, myTitle = "CorrPlot_ZFXkd_v_ZFYkd_demingErr.pdf", myWidth = 1.75, myHeight = 1.75, myXlab = "ZFX kd vs control 46,XX\nlog2 fold change", myYlab = "ZFY kd vs control 46,XX\nlog2 fold change", pointsCol = default_pointsCol, demingBehind = TRUE)
```
...
xx_zfx_expn$FoldChange <- xx_zfx_expn$TPM / xx_zfx_expn_cntrl_mean 

xy_skd_zfx_zfy_expn_cntrl_mean <- mean(xy_skd_zfx_zfy_expn[xy_skd_zfx_zfy_expn$category == "XY_Control_skd","TPM"])
xy_skd_zfx_zfy_expn$FoldChange <- xy_skd_zfx_zfy_expn$TPM / xy_skd_zfx_zfy_expn_cntrl_mean 

xy_dkd_zfx_zfy_expn_cntrl_mean <- mean(xy_dkd_zfx_zfy_expn[xy_dkd_zfx_zfy_expn$category == "XY_Control_dkd","TPM"])
xy_dkd_zfx_zfy_expn$FoldChange <- xy_dkd_zfx_zfy_expn$TPM / xy_dkd_zfx_zfy_expn_cntrl_mean

#compare single kds to double kd fold-changes in cumulative expression!
#XX zfx vs dkd
t.test(x = xx_zfx_expn[xx_zfx_expn$category == "XX_ZFX_kd","FoldChange"], y=xy_dkd_zfx_zfy_expn[xy_dkd_zfx_zfy_expn$category == "XY_ZFX_ZFY_kd_dkd","FoldChange"])

#XY zfx vs dkd
t.test(x = xy_skd_zfx_zfy_expn[xy_skd_zfx_zfy_expn$category == "XY_ZFX_kd_skd","FoldChange"], y=xy_dkd_zfx_zfy_expn[xy_dkd_zfx_zfy_expn$category == "XY_ZFX_ZFY_kd_dkd","FoldChange"])

#XY zfy vs dkd
t.test(x = xy_skd_zfx_zfy_expn[xy_skd_zfx_zfy_expn$category == "XY_ZFY_kd_skd","FoldChange"], y=xy_dkd_zfx_zfy_expn[xy_dkd_zfx_zfy_expn$category == "XY_ZFX_ZFY_kd_dkd","FoldChange"])
```
...
#Show what happens for the Fib genes that are X and Y responsive
```{r}
...
fib_results_X_ALL_genes <- read.delim(file=paste0(myPath,"Linear_regressions/Fibroblasts/fib_x_count_expressed.txt"), stringsAsFactors = FALSE, row.names = 1)
fib_results_Y_ALL_genes <- read.delim(file=paste0(myPath,"Linear_regressions/Fibroblasts/fib_y_count_expressed.txt"), stringsAsFactors = FALSE)
...
#How many of are ZFX and ZFY responsive?
